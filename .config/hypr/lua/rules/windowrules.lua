...
hl.window_rule({
	match = { class = "^btop-floating$" },
	border_color = "rgba(7c3aedff) rgba(cba6f7ff) rgba(b4befeff) rgba(d20f39ff) 180deg rgba(9333eaff) rgba(cba6f7ff) rgba(b4befeff) rgba(c01c28ff) 180deg",
})

-- ── Nmtui Floating — Gradient Active/Inactive ──
hl.window_rule({
	match = { class = "^(nmtui-floating)$" },
	border_color = "rgba(4c1d95ff) rgba(4c1d95ff) rgba(a78bfaff) rgba(f472b6ff) rgba(a78bfaff) 180deg rgba(4c1d95ff) rgba(a78bfaff) rgba(f472b6ff) rgba(a78bfaff) 180deg",
})
