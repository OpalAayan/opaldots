...
local external = "desc:LG Electronics LG ULTRAGEAR 602NTXRFT594"
...
hl.workspace_rule({ workspace = "6", monitor = external, default = true })
...
hl.workspace_rule({ workspace = "10", monitor = external })
