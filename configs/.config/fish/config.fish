...
if status is-interactive
    ...
    # minecraft stuff
    alias mcxx="cd ~/.local/share/PrismLauncher/instances/26.2/minecraft" # minecraft path
    alias mcxy="nautilus ~/.local/share/PrismLauncher/instances/26.2/minecraft & disown" # minecraft path in GUI
    ...
    function fish_user_key_bindings
        bind \r 'if test (commandline) = ";s"; commandline "ls"; end; commandline -f execute'
    end
