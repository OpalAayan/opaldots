...
# Standalone Bluetooth panel logic for quickshell bar popup
# Adapted from nixos-configuration — no external dependencies

STRICT_SPAM_FILTER=true
CACHE_DIR="$HOME/.cache/quickshell/network"
RUN_DIR="${XDG_RUNTIME_DIR:-/tmp}/quickshell/network"
PID_FILE="$RUN_DIR/bt_scan_pid"
...
get_status() {
    # Zero-latency hardware presence check
